...
* Program for forelæsningen og øvelserne kommer torsdag eller fredag i kursusuge 7
...
Der er ikke noget nyt stof i dag. Vi laver lidt repetition via nedenstående opgaver eller et udvalg af dem. Lav opgaverne hjemmefra! Vi kan også bruge tid på spørgsmål fra jer hvis det passer jer bedre.

<!--
* modelkontrol
* ensidet ANOVA med log-transformation
* parrede stikprøver
* blandede modeller
* estimater for tosidet ANOVA
* log-log regression og fortolkning (evt.)
* test af beta = 3 (evt. i linreg og enstikprøve)
* eksempel med relevel
* diskuter opg. 12.5
* løb gamle R programmer igennem
* Case 1: fra kursusuge 2
* 5.8 og 5.10 fra uge 3 nåede mange ikke
* enstikprøveproblemet og resten af kurset (link)
* 8.2 fra uge 6

* Januar 2018, opgave 3, men kun spørgsmål 1+2
* HS.34
* HS.33
* Eventuelle spørgsmål til quiz-delen (opgave 3) fra eksamen i Januar 2019: disse spørgsmål skal komme fra jer!
* Eventuelle spørgsmål til quiz-delen (opgave 3) fra eksamen i November 2018: disse spørgsmål skal komme fra jer!
-->
...
* November 2015, opgave 1. Data ligger som mazdas.txt og mazdas.xlsx på Absalon. Drop evt. spørgsmål (e).
