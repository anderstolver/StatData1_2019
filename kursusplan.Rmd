...
* Link til [zipped folder med kursusmateriale fra hjemmesiden](https://we.tl/t-rip7KRaSCZ). Hvis du åbner filen `index.html` i en browser, så burde da have adgang til filerne på hjemmesiden (selvom du har afbrudt forbindelsen til internettet). Det er ikke sikkert, at løsningen umiddelbart fungerer med alle browsere, men problemerne burde kunne fixes. Linket er næppe permanent, så skriv endelig en email, hvis der opstår problemer.
