...
3 | Mandag (16/9) |  | Resten af Ch. 5 | [link](#uge3) 
...
<!--
* I denne uge skal vi have udvidet vores diskussion af statistiske modeller, estimation, standard errors og konfidensintervaller til også at dække lineær regression og ensidet variansanalyse. Derudover skal vi snakke om hypotesetest. Nogle af jer vil opleve at analyserne hver for sig er nogenlunde nemme at gå til, og at det svære først og fremmest er at finde ud af hvilken analyse der er den korrekte at gribe fat i. Jeg anbefaler at I bruger modelvalgsdiagrammet. (flowdiagram/procesdiagram), som jeg tit viser til forelæsningerne. Det ligger også i Notater, som filen modeller.pdf.

* Du formodes nu (efter kursusuge 2) at være i stand til at læse data ind fra excel- eller tekstfiler (opgave HS.9). Indlæsning af xlsx-filer kræver pakken readxl. Den kan installeres en gang for alle som forklaret i opgave HS.9, men skal loades når du skal bruge den, fx vha. library-funktionen.
