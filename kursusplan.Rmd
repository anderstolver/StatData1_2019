...
3 | Onsdag (18/9) |  | Resten af Ch. 5, Ch. 3.5, (Ch. 6.1-6.2) | link  
...
* I denne uge skal vi have udvidet vores diskussion af statistiske modeller, estimation, standard errors og konfidensintervaller til også at dække lineær regression og ensidet variansanalyse. Derudover skal vi snakke om hypotesetest. Nogle af jer vil opleve at analyserne hver for sig er nogenlunde nemme at gå til, og at det svære først og fremmest er at finde ud af hvilken analyse der er den korrekte at gribe fat i. Jeg anbefaler at I bruger [modelvalgsdiagrammet](slides/modeller.pdf) (flowdiagram/procesdiagram), som jeg tit viser til forelæsningerne.

* Du formodes nu (efter kursusuge 2) at være i stand til at læse data ind fra excel- eller tekstfiler ([opgave HS.9](notater/hs5-12.pdf)). Indlæsning af xlsx-filer kræver pakken readxl. Den kan installeres en gang for alle som forklaret i opgave HS.9, men skal loades når du skal bruge den, fx vha. library-funktionen.
...
* Afsnit 6.1-6.2 om hypotesetest
* Eftermiddag: Fortsat analyse af data om punkplot, denne gang med fokus på sammenligning af mænd og kvinder og fortolkning af estimater efter transformation.
-->

Ved forelæsningen onsdag eftermiddag bruger vi ca. 20 minutter på at gennemgå quizzen hørende til kursusuge 2 (som findes i Absalon). I forventes at have lavet quizzen hjemme inden onsdagsforelæsningen, og vi *spilder* ikke dine medstuderendes tid med at afsætte undervisningstid til, at du kan lave quizzen.
