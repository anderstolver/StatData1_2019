...
[Slides til dagens forelæsning](slides/sd1_forel190902.pdf) - [(Kort version: 4 slides per side)](slides/sd1_forel190902_short.pdf)
...
* R Markdown. R Markdown er et filformat til at generere dokumenter der både indeholder almindelig tekst og R-kode med tilhørende output. Det er helt frivilligt om I vil bruge R Markdown til jeres kursusarbejde, men det kan være en hensigtsmæssig måde at arbejde på. Jeg vil selv bruge det i forbindelse med forelæsningerne, og opgave HS.5 i næste uge hjælper dig i gang.
...
<!--
HS-opgaver kan findes **her - indsæt link**. De øvrige opgaver er fra lærebogen.

* HS.2: Om installation af R-pakker, datasæt fra pakker
* HS.3: Om datasæt og variable i R
