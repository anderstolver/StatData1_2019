...
* Der stilles en frivillig afleveringsopgave til onsdag d. 9. oktober. Nærmere detaljer kommer i løbet af kursusuge 5.
...
* November 2017, opgave 2. Der er ikke data til denne opgave. I anden halvdel af opgave 3 er det nok at bestemme den faktor som regnmængden forøges med (snarere end den procentvise forøgelse); dette gælder både estimat og konfidensinterval.
...
* Find gamle eksamensopgaver med fx. multiple regression eller ikke-lineær regression.
-->
...
* Jeg regner med at stille en frivillig afleveringsopgave til aflevering i kursusuge 7. For at sikre, at I kan nå at få rettet opgaverne, så regner jeg med at afleveringsfristen bliver mandag d. 21/10 (efter ferien).
