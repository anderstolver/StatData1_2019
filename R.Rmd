...
* Ved undervisningen i uge 3 talte vi bl.a. om R kommandoerne
    ...
    _ `t.test`: til sammenligning af to stikprøver (både parrede og uparrede)
...
* R-program fra forelæsning d. 18/9-2019: 
<!-- 
[output](R/forel190918_Rprog.html) - [R Markdown](R/forel190918_Rprog.Rmd) 
-->
