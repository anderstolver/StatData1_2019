...
Dette eksempel har været benyttet ved forelæsningen d. 7/10-2019. Formålet med eksemplet er at illustrere
...
På den sidste del af forelæsningsslides til 7/10-2019 regnes på et datasæt, hvor de husdyrvidenskabstuderende er fjernet. Her genfittes den additive model for tosidet ANOVA (dvs. modellen uden vekselvirkning) alene baseret på de resterende data (dvs. uden HV studerende).
