...
Vi ønsker blandt andet at se på datasættet separat for mænd og kvinder. Neden vises to metoder til at opsplitte data i to.
...
Den bedste løsning er at simulerede/frembringe nogle datasæt *fra en perfekt normalfordeling* som er af samme størrelse som det observerede datasæt. Så kan vi jo direkte optegne QQ-plot for de perfekte datasæt, og se om det observerede QQ-plot falder inden for den usikkerhed/variation, som man vil forvente.
...
* `for(i in 1:4){ ... }` sørger for at gentage R kode (angivet ved `...`) 4 gange. Jeg ønsker her først at lave 4 figurer med simulerede data, dernæst figuren med *rigtige data* og til sidste 4 figurer med simulerede data. 
