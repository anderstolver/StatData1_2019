...
En RMarkdown fil (dvs. en `.Rmd` fil) vil typisk indeholder en såkaldt *YAML header*, som består af nogle kommandoer omkranset af `---`. Disse kommandoer kontrollerer bl.a. forskellige ting, som har betydning for, hvordan output-filen kommer til at se ud, når vi *Knitr* dokumentet.
