...
Dette eksempel supplerer forelæsningsslides fra d. 2/10-2019.
...
Som beskrevet på slides 23-25 fra forelæsning d. 23/9-2019 (og i lærebogens Ch. 6.4), så kan vi teste hypotesen $H_0: \beta_1 = 1, \beta_2 = 2$ ved at fortage en sammenligne (med `anova()`) af
